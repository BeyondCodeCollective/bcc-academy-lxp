...
export const facilitators: Facilitator[] = [
  ...
  },
  {
    ...
    course: "AI for Families & Creative Tech — Beyond Code Centers",
    yearsInIndustry: 18,
    bio: "Jihan is an Afro-Latina EdTech entrepreneur based in the Atlanta Metro area, where she founded The Hip-Hop EdTech Diva — hands-on technology training that fuses hip-hop culture, gaming, VR, and music production. She's a Microsoft Learning Consultant training Georgia educators, a Saint Augustine's University 45 Under 45 honoree, and a regular FETC speaker. At Beyond Code Centers, she leads AI literacy and creative-tech sessions for intergenerational rooms.",
    pathway: "Explorers",
