...
const WEEKS: { week: number; topic: string; icon: string; color: string }[] = [
  { week: 1, topic: "IT Fundamentals", icon: "💻", color: "bg-blue-100" },
  { week: 2, topic: "Devices & OS", icon: "🖥️", color: "bg-purple-100" },
  { week: 3, topic: "Networking", icon: "🌐", color: "bg-cyan-100" },
  { week: 4, topic: "Cybersecurity", icon: "🔒", color: "bg-red-100" },
  { week: 5, topic: "Software & Data", icon: "🗄️", color: "bg-amber-100" },
  { week: 6, topic: "Cloud & Support", icon: "☁️", color: "bg-sky-100" },
  { week: 7, topic: "Cert Review", icon: "🏆", color: "bg-emerald-100" },
];
...
export function ScheduleList({
  ...
  return (
    <div className="space-y-3">
      {WEEKS.map(({ week, topic, icon, color }) => {
