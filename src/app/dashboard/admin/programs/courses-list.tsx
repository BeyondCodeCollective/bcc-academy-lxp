      ...
      <div className="flex items-center gap-4">
        ...
        {course.isEditable && !confirming && (
          <button
            ...
            className="shrink-0 rounded-md border border-neutral-200 bg-white px-3 py-1.5 text-xs font-semibold text-neutral-500 hover:border-red-300 hover:text-red-600 transition-colors"
          >
            Archive
          </button>
        )}
