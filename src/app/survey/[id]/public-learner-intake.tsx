      ...
      <div className="mx-auto w-full max-w-2xl px-5 pb-20">
        <div className="rounded-2xl border border-neutral-200 bg-white p-8 text-center">
          ...
          <p className="mt-2 text-sm text-neutral-600">
            Thanks for sharing. Your information helps us keep this program free and built for people like you.
          </p>
    ...
    <div>
      <div className="mb-6">
        ...
        <p className="mt-1 text-sm text-neutral-700">
          So we can connect your responses to your record if you join a program.
        </p>
      </div>
